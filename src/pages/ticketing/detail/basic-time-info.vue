  ...
  <div class="new-timetick">
    ...
    <div class="yc-info">
      ...
      <div class="add-yc-wrap">
        ...
        <navigator hover-class="none" url="/pages/ticketing/charging-time?back=/pages/ticketing/detail/basic-time-info">
          <div class="addYc">
...
<script>
  ...
  export default {
    ...
    methods: {
      goSite () {
        wx.navigateTo({
          url: '/pages/site-setup/apply-site?back=/pages/ticketing/detail/basic-time-info'
        })
      },
      goCharging () {
        wx.navigateTo({
      ...
      goNext () {
        wx.navigateTo({
          url: '/pages/ticketing/detail/detailed-info?refer=newTimeTick'
        })
      }
    }
  }
